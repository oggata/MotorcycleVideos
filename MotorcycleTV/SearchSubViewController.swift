//
//  SearchSubViewController.swift
//  MotorcycleTV
//
//  Created by Fumitoshi Ogata on 2016/04/13.
//  Copyright © 2016年 Fumitoshi Ogata. All rights reserved.
//

import UIKit

class SearchSubViewController: UITableViewController {
    ...
    override func tableView(table: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = table.dequeueReusableCellWithIdentifier("search_sub_view_cell", forIndexPath: indexPath)
